...
# TODO: Generalize this to group-testing with arbitrary number of groups?
class BeamEnv(gym.Env):
    def __init__(self, config):
        ...
        # TODO: improve this action space?
...
#           print(self.true_state.astype(int))
    ...
    def step(self, action):
        ...
        b1, b2, b3, b4 = action[0], action[1], action[2], action[3]
...
#           assert a != b  # this would be redundant
        ...
        test_result_0 = test_group(b1, b2, self.true_state, test_result_0, render_idx=0 if self.render_gui else None)
        test_result_1 = test_group(b3, b4, self.true_state, test_result_1, render_idx=1 if self.render_gui else None)
...
class Alpha(Agent):
    ...
    def __init__(self, env):
        super(AlphaAgent, self).__init__(env)

    def reset(self):
        self.n_step = 0
        return super(AlphaAgent, self).reset()
